...
<link rel="stylesheet" href="all.css">
    <div class="banner-container">
        <img src="image/Langtang Ganja La Pass Trek Banner.png" alt="Langtang Ganja La Pass Trek Banner" class="banner-image">
    </div>

    <div class="breadcrumb">
        Home &gt; Trekking in Nepal &gt; Langtang Region Trekking &gt; Langtang Ganja La Pass Trek
    </div>
    ...
    <main class="container">
        ...
        <section class="left-column">
            ...
            <p class="itinerary-sub">Day to Day Itinerary &ndash; Langtang Ganja La Pass Trek</p>
            ...
            <div class="booking-card">
                <div class="price-header">
                    <div>
                        ...
                        <span class="price-val">US$1150P/P</span>
                    </div>
                ...
                <button class="btn-widget-outline" style="margin-top: 15px;">Send Inquiry</button>
            </div>
        </aside>
    </main>
    ...
    <script>
        ...
        const basePrice = 1150; // Base package price configuration for Ganja La Pass
        ...
        function handleBookingFlow() {
            if (!isUserLoggedIn) {
                alert("Account not found. Redirecting you to signup page...");
                window.location.href = "signup.jsp";
            } else {
                alert("Redirecting to secure booking checkout...");
